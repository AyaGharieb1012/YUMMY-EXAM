...
$("#contact").on("click", function () {
  ...
  nameInput.addEventListener("blur", () => {
    ...
    else nameAlert.classList.replace("d-none", "d-block");
    checkAllValidation();
  });
  ...
  emailInput.addEventListener("blur", () => {
    ...
    else emailAlert.classList.replace("d-none", "d-block");
    checkAllValidation();
  });
  ...
  phoneInput.addEventListener("blur", () => {
    ...
    else phoneAlert.classList.replace("d-none", "d-block");
    checkAllValidation();
  });
  ...
  ageInput.addEventListener("blur", () => {
    ...
    else ageAlert.classList.replace("d-none", "d-block");
    checkAllValidation();
  });
  ...
  passInput.addEventListener("blur", () => {
    ...
    else passAlert.classList.replace("d-none", "d-block");
    checkAllValidation();
  });
  ...
  repassInput.addEventListener("blur", () => {
    ...
    else repassAlert.classList.replace("d-none", "d-block");
    checkAllValidation();
  });
